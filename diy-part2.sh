...
#修改wifi名称（mtwifi-cfg）
sed -i 's/ASUS_33003/OpenWrt/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
sed -i 's/ASUS_33003_5G/OpenWrt5G/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
